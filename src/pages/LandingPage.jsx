    ...
    <div className="min-h-screen font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled
            ? "bg-white/80 backdrop-blur-md border-b border-blue-100 py-4"
            : "bg-transparent py-6"
        }`}
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-2 group cursor-pointer">
            ...
            <div>
              ...
              <span className="block text-[9px] tracking-wide text-blue-600 -mt-1">
                Dental Studio
              </span>
            </div>
          </div>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <motion.div
              variants={fadeIn}
              className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-blue-50 border border-blue-100 text-blue-700 text-[10px] font-semibold mb-6"
            >
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-1.5 w-1.5 bg-blue-500"></span>
              </span>
              CHATBOT-POWERED DENTAL CARE
            </motion.div>

            <motion.h1
              variants={fadeIn}
              className="text-4xl lg:text-6xl font-normal text-gray-900 leading-[1.1] mb-6"
            >
              The future of <br />
            ...
            >
              Experience a new standard of dental care where advanced technology
              meets human touch. Our AI-driven clinic ensures seamless bookings
            ...
            <motion.div variants={fadeIn} className="flex flex-wrap gap-4">
              ...
              >
                Chatbot <ArrowRight size={18} />
              </button>
              <a
                href="#services"
                className="bg-blue-50 text-blue-600 px-5 py-2 rounded-md text-sm hover:bg-blue-100 transition-all"
              >
      ...
      <section className="py-12 border-y border-gray-100 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-center text-[10px] text-blue-600 tracking-wide mb-10">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-[10px] text-blue-600 tracking-wide mb-3">
              Our Expertise
            </h2>
            <h3 className="text-3xl md:text-4xl font-normal text-gray-900 mb-5 tracking-tight">
              Everything you need for a{" "}
              <span className="text-blue-600">perfect smile.</span>
            </h3>
            <p className="text-base text-gray-600">
              We offer a wide range of services powered by latest dental
              ...
              <div className="space-y-4">
                {[
                  ...
                  },
                  {
                    ...
                    desc: "No more messy molds. 3D intraoral scans in under 60 seconds.",
                    icon: <CheckCircle2 className="text-blue-600" />,
                  },
                  {
                    title: "Guided Surgeries",
                    desc: "Robotic precision for dental implants and restorative work.",
                    icon: <Shield className="text-blue-600" />,
                  },
                ].map((item, i) => (
                  <div
                    key={i}
                    className="flex gap-4 p-3 rounded-2xl hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100"
                  >
              ...
              <div className="relative glass-card rounded-[32px] p-6 border border-gray-200">
                <div className="aspect-video bg-slate-900 rounded-[24px] overflow-hidden relative shadow-2xl">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 p-3 bg-white/10 backdrop-blur-md rounded-xl border border-white/10 text-white">
                    <div className="text-[9px] font-bold uppercase tracking-widest mb-0.5 opacity-60">
                      Now Watching
                    </div>
                    <div className="text-xs font-bold">
                      The AI Clinic Experience
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              ...
              <h3 className="text-3xl font-normal text-gray-900 tracking-tight">
                Recent Reservations
              </h3>
            </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-[1fr_1.5fr] gap-20 items-center">
            <div>
              <h2 className="text-[10px] text-blue-600 tracking-wide mb-5">
                Patient Stories
              </h2>
              <h3 className="text-4xl font-normal mb-6 leading-tight">
                Loved by the community.
              </h3>
              <p className="text-slate-600 text-base mb-8">
                We pride ourselves on providing exceptional care that leaves our
                patients smiling.
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="p-8 rounded-[40px] bg-white border border-slate-200"
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div>{t.name}</div>
                      <div className="text-[10px] text-blue-600 tracking-wider">
                        {t.role}
                      </div>
                    </div>
                  </div>
          ...
          <div className="relative rounded-[60px] bg-blue-50 p-12 md:p-20 overflow-hidden text-center border border-slate-200">
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-600 text-base mb-10 max-w-xl mx-auto">
                Join thousands of patients who have switched to a smarter way of
                caring for their smiles.
              </p>
      ...
      <footer className="py-20 bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12 mb-20">
            <div className="col-span-2">
              ...
              <div className="flex gap-4">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-400 hover:text-blue-600 hover:border-blue-600 transition-colors cursor-pointer"
                  >
                    <Sparkles size={18} />
                  </div>
                ))}
            ...
            <div>
              <h4 className="text-gray-900 mb-8 tracking-wide text-xs">
                Resources
              </h4>
              <ul className="space-y-4">
                {["About Us", "Services", "Our Team", "AI Lab", "Contact"].map(
                  (item) => (
                    <li key={item}>
                      <a
                        href="#"
              ...
              <ul className="space-y-6">
                ...
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:hello@smilecare.ai"
                      className="text-sm text-gray-900 hover:text-blue-600 transition-colors"
                    >
                      hello@smilecare.ai
                    </a>
          ...
          <div className="pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-6">
            <p className="text-gray-400 text-sm font-medium">
              © 2026 SmileCare Dental Studio. All rights reserved.
            </p>
